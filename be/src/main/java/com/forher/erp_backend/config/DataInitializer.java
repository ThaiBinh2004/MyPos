...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedProducts() {
        ...
        productRepository.save(Product.builder().productId("PRD001").sku("FH-AO-001").productName("Áo sơ mi trắng dài tay").price(new BigDecimal("320000")).sizeInfo("S/M/L/XL").color("Trắng").imageUrl("https://images.unsplash.com/photo-1598033129183-c4f50c736f10?w=400&q=80").category(ao).build());
        productRepository.save(Product.builder().productId("PRD002").sku("FH-AO-002").productName("Áo thun basic cổ tròn").price(new BigDecimal("180000")).sizeInfo("S/M/L").color("Đen").imageUrl("https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&q=80").category(ao).build());
        productRepository.save(Product.builder().productId("PRD003").sku("FH-AO-003").productName("Áo blouse hoa nhí").price(new BigDecimal("250000")).sizeInfo("S/M/L").color("Hồng").imageUrl("https://images.unsplash.com/photo-1585487000160-6ebcfceb0d03?w=400&q=80").category(ao).build());
        productRepository.save(Product.builder().productId("PRD004").sku("FH-AO-004").productName("Áo croptop thể thao").price(new BigDecimal("150000")).sizeInfo("S/M").color("Xanh navy").imageUrl("https://images.unsplash.com/photo-1554568218-0f1715e72254?w=400&q=80").category(ao).build());
        productRepository.save(Product.builder().productId("PRD005").sku("FH-QU-001").productName("Quần jean ống rộng").price(new BigDecimal("420000")).sizeInfo("26/27/28/29/30").color("Xanh nhạt").imageUrl("https://images.unsplash.com/photo-1541099649105-f69ad21f3246?w=400&q=80").category(quan).build());
        productRepository.save(Product.builder().productId("PRD006").sku("FH-QU-002").productName("Quần kaki lưng cao").price(new BigDecimal("380000")).sizeInfo("26/27/28/29").color("Be").imageUrl("https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=400&q=80").category(quan).build());
        productRepository.save(Product.builder().productId("PRD007").sku("FH-QU-003").productName("Quần short denim").price(new BigDecimal("220000")).sizeInfo("S/M/L").color("Xanh đậm").imageUrl("https://images.unsplash.com/photo-1591195853828-11db59a44f43?w=400&q=80").category(quan).build());
        productRepository.save(Product.builder().productId("PRD008").sku("FH-VA-001").productName("Váy midi hoa nhí").price(new BigDecimal("350000")).sizeInfo("S/M/L").color("Vàng").imageUrl("https://images.unsplash.com/photo-1583496661160-fb5974ca0b98?w=400&q=80").category(vay).build());
        productRepository.save(Product.builder().productId("PRD009").sku("FH-VA-002").productName("Đầm wrap dress").price(new BigDecimal("480000")).sizeInfo("S/M/L").color("Đỏ đô").imageUrl("https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=400&q=80").category(vay).build());
        productRepository.save(Product.builder().productId("PRD010").sku("FH-VA-003").productName("Váy mini tennis").price(new BigDecimal("280000")).sizeInfo("S/M").color("Trắng").imageUrl("https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=400&q=80").category(vay).build());
        productRepository.save(Product.builder().productId("PRD011").sku("FH-PK-001").productName("Túi xách tote canvas").price(new BigDecimal("220000")).color("Be").imageUrl("https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&q=80").category(pk).build());
        productRepository.save(Product.builder().productId("PRD012").sku("FH-PK-002").productName("Thắt lưng da PU").price(new BigDecimal("130000")).color("Đen").imageUrl("https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&q=80").category(pk).build());
